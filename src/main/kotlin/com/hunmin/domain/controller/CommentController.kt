...
class CommentController(
    ...
    fun createComment(@PathVariable boardId: Long, @RequestBody commentRequestDTO: CommentRequestDTO): ResponseEntity<CommentResponseDTO> {
    ...
    fun createCommentChild(@PathVariable boardId: Long, @PathVariable commentId: Long,
                           @RequestBody commentRequestDTO: CommentRequestDTO): ResponseEntity<CommentResponseDTO> {
