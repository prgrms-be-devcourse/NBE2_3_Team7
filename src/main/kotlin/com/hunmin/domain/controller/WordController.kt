...
class WordController (
    ...
    fun createWord(@Validated @RequestBody wordRequestDTO: WordRequestDTO,
        ...
        val createdWord = wordService.createWord(wordRequestDTO)
    ...
    fun updateWord(@Validated @RequestBody wordRequestDTO: WordRequestDTO,
        ...
        val updatedWord = wordService.updateWord(wordRequestDTO)
    ...
    fun deleteWord(@PathVariable title: String, @PathVariable lang: String,
                   @AuthenticationPrincipal userDetails: CustomUserDetails): ResponseEntity<Map<String, String>> {
        wordService.deleteWord(title, lang, userDetails.getMemberId())
